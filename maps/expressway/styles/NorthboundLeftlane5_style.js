var size = 0;
var ranges_NorthboundLeftlane5 = [[0.000000, 1.000000, [ new ol.style.Style({
...
var styleCache_NorthboundLeftlane5={}
var style_NorthboundLeftlane5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("CPX level");
    var style = ranges_NorthboundLeftlane5[0][2];
    for (i = 0; i < ranges_NorthboundLeftlane5.length; i++){
        var range = ranges_NorthboundLeftlane5[i];
    ...
    if (typeof clusteredFeatures !== "undefined") {
        ...
        if (!styleCache_NorthboundLeftlane5[key]){
            ...
            styleCache_NorthboundLeftlane5[key] = new ol.style.Style({"text": text})
        }
    } else {
        if ("" !== null) {
            labelText = String("");
    ...
    var allStyles = [styleCache_NorthboundLeftlane5[key]];
