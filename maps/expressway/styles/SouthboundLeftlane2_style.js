var size = 0;
var ranges_SouthboundLeftlane2 = [[0.000000, 1.000000, [ new ol.style.Style({
...
var styleCache_SouthboundLeftlane2={}
var style_SouthboundLeftlane2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("CPX level");
    var style = ranges_SouthboundLeftlane2[0][2];
    for (i = 0; i < ranges_SouthboundLeftlane2.length; i++){
        var range = ranges_SouthboundLeftlane2[i];
    ...
    if (typeof clusteredFeatures !== "undefined") {
        ...
        if (!styleCache_SouthboundLeftlane2[key]){
            ...
            styleCache_SouthboundLeftlane2[key] = new ol.style.Style({"text": text})
        }
    } else {
        if ("" !== null) {
            labelText = String("");
    ...
    var allStyles = [styleCache_SouthboundLeftlane2[key]];
