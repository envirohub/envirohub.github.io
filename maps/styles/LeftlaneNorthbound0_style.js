var size = 0;
var ranges_LeftlaneNorthbound0 = [[0.000000, 1.000000, [ new ol.style.Style({
...
var styleCache_LeftlaneNorthbound0={}
var style_LeftlaneNorthbound0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("CPX level");
    var style = ranges_LeftlaneNorthbound0[0][2];
    for (i = 0; i < ranges_LeftlaneNorthbound0.length; i++){
        var range = ranges_LeftlaneNorthbound0[i];
    ...
    if (typeof clusteredFeatures !== "undefined") {
        ...
        if (!styleCache_LeftlaneNorthbound0[key]){
            ...
            styleCache_LeftlaneNorthbound0[key] = new ol.style.Style({"text": text})
        }
    } else {
        if ("" !== null) {
            labelText = String("");
    ...
    var allStyles = [styleCache_LeftlaneNorthbound0[key]];
