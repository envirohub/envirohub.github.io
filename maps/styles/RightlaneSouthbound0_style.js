var size = 0;
var ranges_RightlaneSouthbound0 = [[0.000000, 1.000000, [ new ol.style.Style({
...
var styleCache_RightlaneSouthbound0={}
var style_RightlaneSouthbound0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("CPX level");
    var style = ranges_RightlaneSouthbound0[0][2];
    for (i = 0; i < ranges_RightlaneSouthbound0.length; i++){
        var range = ranges_RightlaneSouthbound0[i];
    ...
    if (typeof clusteredFeatures !== "undefined") {
        ...
        if (!styleCache_RightlaneSouthbound0[key]){
            ...
            styleCache_RightlaneSouthbound0[key] = new ol.style.Style({"text": text})
        }
    } else {
        if ("" !== null) {
            labelText = String("");
    ...
    var allStyles = [styleCache_RightlaneSouthbound0[key]];
